        ...
        <table class="table table-bordered table-stripped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('categories.show', ['id' => $category->id]) }}" class="btn btn-info btn-sm"> Show </a>
                        <a href="{{ route('categories.edit', ['id' => $category->id]) }}" class="btn btn-warning text-white btn-sm"> Edit </a>
                        <form
                        class="d-inline"
