        ...
        <div class="row">
            <div class="col-md-6">
                <ul class="nav nav-pills card-header-pills">
                    <li class="nav-item">
                        <a class="nav-link {{ empty(Request::get('status')) && Request::path() == 'books' ? 'active' : '' }}" href="{{ route('books.index') }}">All</a>
                    </li>
                    <li class="nav-item">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('books.permanent-delete', ['id' => $book->id]) }}" class="d-inline" onsubmit="return confirm('Delete this book permanently?')" >
                            @csrf
