...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('users.show', ['id' => $user->id]) }}" class="btn btn-info btn-sm">Detail</a>
                <a class="btn btn-warning text-white btn-sm" href="{{ route('users.edit', ['id' => $user->id]) }}">Edit</a>
